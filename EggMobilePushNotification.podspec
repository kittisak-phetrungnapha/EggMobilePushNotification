...
Pod::Spec.new do |s|
  ...
  s.version          = "0.1.0"
  s.summary          = "The library that provides an application is integrated with ANC Push Notification service."
...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/EggMobilePushNotification.git", :tag => s.version.to_s }
